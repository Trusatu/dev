...
<body>
	...
	<!-- Header -->
	<header id="header" class="image dim" style="background-image: url('img/bg_header.jpg');" data-center="background-position: 50% 60%" data-top-bottom="background-position: 50% -60%">
		<div class="container">
			<div class="navbar" role="navigation">
				...
				<nav class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="sub">
							<a href="about.html" title="About">Qui somme-nous</a>
							<ul>
								<li><a href="icons.html" title="Icons">Icons</a></li>
								<li><a href="landing.html" title="Landing">Landing</a></li>
							</ul>
						...
						<li class="login"><a href="{{ url('/auth/login') }}" title="Login"><i class="icon fa fa-lock"></i> Login</a></li>
							@else
							
							<li><a href="{{ url('/auth/logout') }}">Logout</a></li>
							<li class="dropdown">
							<a href="#" class="logout" data-toggle="dropdown" role="button" aria-expanded="false">{{ Auth::user()->name }} <span class="caret"></span></a>
...
<div class="row">
					<div class="col-xs-12 col-md-10 col-md-offset-1">
						<form class="form loginRegistrationForm" role="form" method="POST" action="{{ url('/auth/register') }}">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-4 i">
									...
									<div class="input">
			                           	...
			                           	<input type="text" class="form-control input-field" name="name" value="{{ old('name') }}">
								...
								<div class="col-xs-12 col-sm-4 i">
									...
									<div class="input">
										<input type="password" class="form-control input-field" name="password_confirmation">
										<label class="input-label">
	...
	<footer id="footer">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-sm-3 i">
						<h2>Trusatu</h2>
						<div class="content">
							16 Rue colotte Audry<br />
							77214 Villenoy<br />
							France<br />
							01 43 19 20 00<br />
							<a href="#" title="#">madeny@trusatu.com</a>
						</div>
					</div>
					<div class="col-xs-6 col-sm-3 i">
						<h2>Newsletter</h2>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-xs-6 i">Copyright © 2015 <a href="http://madenyinc.com" title="CloudArena">CloudArena</a></div>
					<div class="col-xs-6 i">Web Design: <a href="http://trusatu.com/" title="Juraj Molnar" target="_blank">Madeny</a></div>
				</div>
			</div>
		</div>
	</footer>
